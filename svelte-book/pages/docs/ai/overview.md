---
type: Web Page
title: Overview • Svelte AI Docs
description: Overview • Svelte AI documentation
resource: https://svelte.dev/docs/ai/overview
...
- [Skills](skills): lazy-loaded descriptions that teach your agent Svelte best practices, and how to use the- `@sveltejs/mcp`cli
...
[ Edit this page on GitHub](https://github.com/sveltejs/ai/edit/main/documentation/docs/10-introduction/10-overview.md) [ llms.txt](/docs/ai/overview/llms.txt)

previous next

# Citations

1. Source page: https://svelte.dev/docs/ai/overview
